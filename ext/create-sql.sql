-- LANCER CETTE COMMANDE DANS UN SHELL --
-- mysql -u root -p -D racurl < create-sql.sql

GRANT ALL PRIVILEGES ON racurl.* To 'racurluser'@'localhost' IDENTIFIED BY 'racurlpwd';
CREATE DATABASE IF NOT EXISTS racurl DEFAULT CHARACTER SET utf8;
